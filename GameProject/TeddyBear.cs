    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (elapsedShotMilliseconds > firingDelay)
            {
                ...
                firingDelay = GetRandomFiringDelay();
                Projectile projectile = new Projectile(ProjectileType.TeddyBear, Game1.GetProjectileSprite(ProjectileType.TeddyBear), drawRectangle.X + drawRectangle.Width / 2, drawRectangle.Y + drawRectangle.Height / 2 + GameConstants.TeddyBearProjectileOffset, -GetProjectileYVelocity());
