    ...
    public class Burger
    {
        ...
        public void Update(GameTime gameTime, MouseState mouse)
        {
            ...
            if (health > 0)
            {
                ...
                if (drawRectangle.X > GameConstants.WindowWidth - drawRectangle.Width)
                {
                ...
                if(drawRectangle.Y>GameConstants.WindowHeight - drawRectangle.Height)
                {
                ...
                {
                    canShoot = false;
                    Projectile projectile = new Projectile(ProjectileType.FrenchFries, Game1.GetProjectileSprite(ProjectileType.FrenchFries), drawRectangle.X + drawRectangle.Width/2, drawRectangle.Y + drawRectangle.Height/2 + GameConstants.FrenchFriesProjectileOffset, GameConstants.FrenchFriesProjectileSpeed);
